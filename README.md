...
## Structure 
![image](https://raw.githubusercontent.com/xhsiung/wechatsslandroid/master/imgs/flow.png)

## View
![image](https://raw.githubusercontent.com/xhsiung/wechatsslandroid/master/imgs/screen.jpg)
...
<script>
   ...
   function send(){
        ...
        var pack = {"channel":"u002@u001","action":"send","sid":"u002","tid":"u001","gid":"","corps":0,"category":"","data":"123","status":0,"created_time":"","updated_time":"","location_name":"","location_address":"","location_phone":"","location_latitude":0,"location_longitude":0,"device":"desktop|mobile"}
   ...
   function sendwrapData(){
        //var newchann =  wechat.getInviteChann($("#isid").val() , $("#itid").val()  )
        var pack = { device:"desktop|mobile", channel: $("#xchannel").val(),sid: $("#isid").val() ,tid: $("#itid").val() , action:"send",  category:"user", dataType:"Text" , dataText:$("#xmsg").val() };
   ...
   function register(){
       ...
       //var obj = { action: "insert" ,m_id: "u20696", custom_name:"alex" , corps:-1,  created_time:"1479959062201",updated_time:"1479959062300" } ;
